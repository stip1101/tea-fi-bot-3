...
### /admindashboard
Program dashboard with overview stats.
...
### /adminban @user
Ban a user from the program.

### /adminunban @user
Unban a previously banned user.

### /admincreate-task
Create a new task with name, description, and XP reward.

### /admintasks
List and manage existing tasks.

### /adminreport
Export CSV reports with program data.
